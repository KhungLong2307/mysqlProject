...
public class ReceiptPresentation {
    ...
    public void case1(Scanner sc){
        ...
        do {
            billList.clear();
            maxOffSet = iBill.getLengthBillIn(true,"");
            billList.addAll(iBill.getBillIn(offSet,true,""));
            displayTable();
            bar(sc);
        }while (!isOutTable);
    }
    ...
    public void case6(Scanner sc){
        ...
        do {
            ...
            if (input.toLowerCase().equals("exit")){
                ...
                do {
                    billList.clear();
                    maxOffSet = iBill.getLengthBillIn(true,input);
                    if (maxOffSet==0){
                        System.out.println(colorRed("Không tìm thấy dữ liệu"));
                        bar(sc);
                    }else {
                        billList.addAll(iBill.getBillIn(offSet,true,input));
                        displayTable();
                        barUpdate(sc);
                    }
                }while (!isOutTable);
    ...
    public void caculator(Bill bill){
        billDetailList.clear();
        ...
        for (BillDetail billDetail: billDetailList){
            ...
            int add = billDetail.getQuantity() + product.getQuantity();
